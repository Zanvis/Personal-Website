...
export class CoreComponent {
  projects: Project[] = [
    ...
    { title: 'Animation', category: 'C#', date: new Date('2024-04-04'), image: 'CSharpImages/Animation/thumb.png', videoSrc: 'CSharpImages/Animation/video.mp4', type: 'School project', link: 'https://github.com/Zanvis/Animation', description: 'The Bouncing Balls Simulator is a C# application that simulates the movement of colored balls within a window. The balls bounce off the window edges and each other. Users can start, stop, and resume the animation, randomize the initial positions of the balls, and reset them to the starting position. The application also allows users to adjust the speed and number of balls in the simulation.' },
    ...
    { title: 'Presentation of Geometric Solids', date: new Date('2023-05-14'), category: 'C#', image: 'CSharpImages/BrylyGeometryczne/thumb.png', videoSrc: 'CSharpImages/BrylyGeometryczne/video.mp4', type: 'School project', link: 'https://github.com/Zanvis/Prezentacja-figur-geometrycznych', description: 'This school project is a 3D geometric shape editor and viewer written in C#. It allows users to create, manipulate, and visualize various geometric solids, such as prisms, pyramids, sloping prisms, and sloping pyramids. Users can customize shape attributes like height, radius, polygon base degree, line thickness, tilt angle, line color, and style. The application includes features for adding and removing shapes, random repositioning, and controlling the visualization through a slideshow and rotation options. The interface displays the shapes in a central viewing area with a coordinate table, making it an educational tool for understanding geometry and transformations.' },
