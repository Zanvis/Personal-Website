...
export class CoreComponent {
  projects: Project[] = [
    ...
    { title: 'Prezentacja brył geometrycznych', date: new Date('2023-05-14'), category: 'C#', image: 'CSharpImages/BrylyGeometryczne/thumb.png', videoSrc: 'CSharpImages/BrylyGeometryczne/video.mp4', type: 'Desktop app', link: 'https://github.com/Zanvis/Prezentacja-figur-geometrycznych', description: 'This school project is a 3D geometric shape editor and viewer written in C#. It allows users to create, manipulate, and visualize various geometric solids, such as prisms, pyramids, sloping prisms, and sloping pyramids. Users can customize shape attributes like height, radius, polygon base degree, line thickness, tilt angle, line color, and style. The application includes features for adding and removing shapes, random repositioning, and controlling the visualization through a slideshow and rotation options. The interface displays the shapes in a central viewing area with a coordinate table, making it an educational tool for understanding geometry and transformations.' },
    { title: 'Analizator szeregów', category: 'C#', date: new Date('2022-11-21'), image: 'CSharpImages/AnalizatorSzeregow/thumb.png', videoSrc: 'CSharpImages/AnalizatorSzeregow/video.mp4', type: 'Desktop app', link: 'https://github.com/Zanvis/Analizator-szeregow', description: 'The Power Series Analyzer is a C# application designed for analyzing and visualizing power series. It allows users to input parameters such as the independent variable 𝑋, accuracy 𝐸𝑝𝑠, and range bounds ( 𝑋𝑑 and 𝑋𝑔), and calculates the series value 𝑆(𝑋). The application displays the computed values in a table and provides graphical visualization of the series behavior over the specified range.' },
  ];
